...
export async function api(context, baseURL, path, method = "GET", data) {
...
export async function register(context, baseURL, username = `user_${randomUUID().replaceAll("-", "").slice(0, 20)}`) {
